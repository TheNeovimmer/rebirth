...
<body data-user-id="<?= $_SESSION['user_id'] ?? 0 ?>">
  <div class="app-layout">
    ...
    <nav class="app-tabs">
      ...
      <a href="/therapist/resources" class="app-tab <?= $page === 'Resources' ? 'active' : '' ?>"><i class="fa-solid fa-folder-open"></i><span>Resources</span></a>
    </nav>
    <?php else: ?>
    <nav class="app-tabs">
      <a href="/panel/dashboard" class="app-tab <?= $page === 'Dashboard' ? 'active' : '' ?>"><i class="fa-solid fa-house"></i><span>Home</span></a>
      ...
      <a href="/panel/community" class="app-tab <?= $page === 'Community' ? 'active' : '' ?>"><i class="fa-regular fa-comments"></i><span>Community</span></a>
      <a href="/panel/resources" class="app-tab <?= $page === 'Resources' ? 'active' : '' ?>"><i class="fa-regular fa-file-lines"></i><span>Resources</span></a>
    </nav>
    <?php endif; ?>
